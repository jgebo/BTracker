...
namespace BTracker.Controllers
{
    public class TicketHistoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,TicketId,Property,UserName,OldValue,NewValue,Changed")] TicketHistory ticketHistory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,TicketId,Property,UserName,OldValue,NewValue,Changed")] TicketHistory ticketHistory)
        {
            if (ModelState.IsValid)
            {
